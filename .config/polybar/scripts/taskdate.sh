...
if [ "$($TASK +READY +OVERDUE count)" -gt 0 ]; then
  echo "%{F#F0DD74}%{B#627D82}%{B-}%{F-}${SYNC}%{F#cd1f3f}%{B#F0DD74}${OVERDUE} %{B-}%{F-}%{F#ABA167}%{B#F0DD74}%{F#000}%{B#ABA167}Week ${FORMAT} %{B-}%{F-}"
elif [ "$($TASK +DUETODAY count)" -gt 0 ]; then
  echo "%{F#F0DD74}%{B#627D82}%{B-}%{F-}${SYNC}%{F#a3c725}%{B#F0DD74}${DUETODAY} %{B-}%{F-}%{F#ABA167}%{B#F0DD74}%{F#000}%{B#ABA167}Week ${FORMAT} %{B-}%{F-}"
else
